...
tags: 继承
cover: /assets/media/1*alaNvn0eN2rABbAifovcwQ.jpeg
---
* content
{:toc}
...
* ❌ 不能定义共享属性方法/或写在外面失去了封装性
    ...
    ```
    ![](/assets/media/1698bac5df93d826.png)
...
* ❌ 没办法向父类传递参数
    ...
    ![](/assets/media/1698bac5dfb4e812.png)
...
* ⚡ 重复调用父类性能损耗
    ...
    ```
    ![](/assets/media/1698bac5dfd6c0b6.png)
...
* ❌ 子类不可传递参数给父类
    ...
    ```
    ![](/assets/media/1698bac5dfecdeab.png)
...
![](/assets/media/1698bac5e05d116f.png)

## 小结

最后上个图作为总结：

![](/assets/media/1698bac617e0f42b.png)
