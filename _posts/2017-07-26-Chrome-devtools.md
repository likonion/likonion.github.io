...
cover: /assets/media/chrome-devtools.jpeg
---
* content
{:toc}
...
![](/assets/media/15012062628062.png)
...
![](/assets/media/15012062982540.png)
...
![](/assets/media/15012064459372.png)



## 05 IOS真机模拟
这个虽然和Chrome没关系，但是也可以提一下，Mac的XCode可以开一个ios系统，操作如下图所示，然后可以用Mac的Safari接连这个ios里面的Safari进行检查：
![](/assets/media/15012064637322.png)


如下例子调试iPhone的Safari：
![](/assets/media/15012064814217.png)
...
![](/assets/media/15012064998212.png)



当上一次请求还没完成又要发一个新的请求的时候，代码里面会把上一次请求abort掉，所以会看到上一个变红了：
![](/assets/media/15012065202049.png)
...
![](/assets/media/15012065619103.png)
...
![](/assets/media/15012065796738.png)


首先定位到mouseover事件，因为它必定是mouseover触发的：
![](/assets/media/15012065934674.png)


一打开发现代码是压缩的：
![](/assets/media/15012066063035.png)


压缩的代码可以点左下角的大括号，进行美化：
![](/assets/media/15012066202521.png)



然后再用快捷键一步步的step over/step into，如果你不用快捷键老是一个个去点那个调试的按钮还是挺麻烦的。如果不小心过了，就重新来一遍。最后会找到在这个函数里面画的边界：
![](/assets/media/15012066317050.png)
...
![](/assets/media/15012066451932.png)
...
![](/assets/media/15012066591461.jpg)
...
![](/assets/media/15012066723912.jpg)
...
![](/assets/media/15012066914661.jpg)
...
![](/assets/media/15012068119532.png)
...
![](/assets/media/15012068002677.png)

然后就会把当前内存的使用情况显示出来：

![](/assets/media/15012067920057.png)
...
![](/assets/media/15012067424282.png)
...
![](/assets/media/15012067330570.png)

另外图片的优先级会低于CSS/JS资源，并且同一个域最多只能同时加载6个资源，所以会有排队和等待时间，如下图所示：


![](/assets/media/15012067184535.png)
