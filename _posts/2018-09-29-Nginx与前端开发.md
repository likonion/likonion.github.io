...
tags: nginx
cover: /assets/media/nginx-thumbnail.png
---
* content
{:toc}
...
们访问墙外服务器server的网页请求，代理到一个可以访问该网站的代理服务器proxy，这个代理服务器proxy把墙外服务器server上的网页内容获取，再转发给客户。具体的流程如下图。
    ![](/assets/media/1661ac31c06b0681.jpeg)
...
2. **反向代理**
    ...
    反向代理则正好相反，先看流程图图。
    ![](/assets/media/1661ac31c192d22f.jpeg)
...
2. **解决跨域**
    ...
    ![](/assets/media/1661ac31c1944c05.jpeg)
...
3. **适配PC与移动环境**
    ...
    ![](/assets/media/1661ac31c1a18887.gif)
...
4. **合并请求**
    ...
    ![](/assets/media/1661ac31c0b189ea.jpeg)
    ...
    ![](/assets/media/1661ac31c27214fa.jpeg)
...
5. **图片处理**
    ...
    ```
    ![](/assets/media/1661ac31eb85e6f4.gif)
...
6. **页面内容修改**
    ...
    ```
    ![](/assets/media/1661ac31f0d611ca.gif)
